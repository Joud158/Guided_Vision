...
PROMPT = (
    ...
    "Mention the main objects, people, and their positions "
    "(front / left / right / behind) and approximate distance in meters "
    "if you can. Do not talk about being an AI or an assistant. "
    "Do not repeat the prompt. Just answer with the description sentence.\n"
    "Assistant:"
)
